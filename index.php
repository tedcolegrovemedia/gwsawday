...
<body>
  ...
  <main class="builder">
    ...
    <section class="builder-panel" aria-label="App builder">
      <ol class="step-indicator" aria-hidden="true">
        ...
        <li class="step-pill"            data-pill="2"><span>2</span> Cards</li>
        <li class="step-pill"            data-pill="3"><span>3</span> Buttons</li>
        <li class="step-pill"            data-pill="4"><span>4</span> Footer</li>
      </ol>

      <!-- Step 1: Header (name + image topic + font) -->
      <div class="step-panel is-active" data-step="1">
        <h2>Step 1 · Design the header</h2>
        <p class="step-hint">Give your app a name, pick a picture topic, and choose a font style.</p>
      ...
      <div class="step-panel" data-step="2">
        <h2>Step 2 · Add fun cards</h2>
        <p class="step-hint">Pick an emoji, add a short title, and a little caption. Make up to <?= (int)MAX_CARDS ?> cards!</p>

        <div id="cards-list"></div>
        <button type="button" class="btn btn-ghost" id="add-card">+ Add another card</button>
    ...
    <section class="preview-panel" aria-label="Live preview">
      <div class="phone">
        <div class="phone-frame">
          ...
          <div class="phone-screen" id="phone-screen" data-font="fredoka">
  ...
  <!-- Emoji picker modal -->
  <div class="emoji-modal" id="emoji-modal" hidden>
    <div class="emoji-modal-backdrop" data-close></div>
    <div class="emoji-modal-panel">
      <div class="emoji-modal-head">
        <span>Pick an emoji</span>
        <button type="button" class="emoji-modal-close" data-close aria-label="Close">×</button>
      </div>
      <div class="emoji-grid">
        <?php foreach ($emoji_grid as $e): ?>
          <button type="button" class="emoji-cell" data-emoji="<?= htmlspecialchars($e, ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($e, ENT_QUOTES, 'UTF-8') ?></button>
        <?php endforeach; ?>
      </div>
    </div>
  </div>
